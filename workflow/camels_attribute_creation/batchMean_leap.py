# This is a script to calculate and upload annual monthly means of GLASS attributes for leap years
...
mm.apr_leap(workdir, attribute, year)
mm.may_leap(workdir, attribute, year)
...
mm.oct_leap(workdir, attribute, year)
mm.nov_leap(workdir, attribute, year)
